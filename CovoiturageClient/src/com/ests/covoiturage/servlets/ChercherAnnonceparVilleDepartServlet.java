...
/**
 * Servlet implementation class ChercherAnnonceparVilleDepartServlet
 */
@WebServlet("/ChercherAnnonceparVilleDepartServlet")
public class ChercherAnnonceparVilleDepartServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ChercherAnnonceparVilleDepartServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			Annonce[] resultat = service.chercherAnnonceparVilleDepart(villeDepart);
