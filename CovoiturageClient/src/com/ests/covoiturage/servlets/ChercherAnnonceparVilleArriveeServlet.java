...
/**
 * Servlet implementation class ChercherAnnonceparVilleArriveeServlet
 */
@WebServlet("/ChercherAnnonceparVilleArriveeServlet")
public class ChercherAnnonceparVilleArriveeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ChercherAnnonceparVilleArriveeServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			Annonce[] resultat = service.chercherAnnonceparVilleArrivee(villeArrivee);
