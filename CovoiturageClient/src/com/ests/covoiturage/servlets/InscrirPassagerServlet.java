...
/**
 * Servlet implementation class InscrirPassagerServlet
 */
@WebServlet("/InscrirPassagerServlet")
public class InscrirPassagerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InscrirPassagerServlet() {
        super();
