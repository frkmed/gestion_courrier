...
/**
 * Servlet implementation class ChercherAnnonceparDateServlet
 */
@WebServlet("/ChercherAnnonceparDateServlet")
public class ChercherAnnonceparDateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ChercherAnnonceparDateServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String dateCovoiturage = request.getParameter("date");
		...
		try {
			...
			Annonce[] resultat = service.chercherAnnonceparDate(dateCovoiturage);
