...
data=[
  ...
  {'id':40,'type':'recherche','categorie':'public','date':'5/9/2018','correspondant': 'assia','objet':'facture','destination':'service budget'},
  {'id':50,'type':'recherche','categorie':'prive','date':'23/8/2018','correspondant': 'hajhouj','objet':'facture','destination':'service budget'},
